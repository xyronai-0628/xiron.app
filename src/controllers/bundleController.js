...
import { deductCreditsServer, incrementDailyCount } from '../middleware/planValidation.js';
...
export async function generateBundle(req, res) {
    ...
    try {
        ...
        res.json({
            ...
            creditsRemaining: deductResult.success ? deductResult.newCredits : verifiedCredits,
